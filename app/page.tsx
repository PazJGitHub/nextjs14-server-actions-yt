...
async function getData() { // this will grab the data from the database
...
export default async function Home() {// this will send data to database
        ...
        <div className="mt-5 flex flex-col gap-y-2">
          {data.map((todo) => (
            <form key={todo.id} className="flex" action={edit}>
              ...
              <button className="border bg-green-400" type="submit" >Save</button>
